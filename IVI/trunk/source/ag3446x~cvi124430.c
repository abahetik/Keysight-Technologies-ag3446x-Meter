/**********************************************************************************
 *  Copyright 2013 - 2015, National Instruments, Corporation.  All Rights Reserved. *
 **********************************************************************************/
...
{   /* Attribute ID,                  			SCPI command       */
    { AG3446X_ATTR_SCALE_FUNCTION,       		"CALC:SCAL:FUNC", 			""      },
...
{   /* Attribute ID,                  							SCPI command       */
    ...
    { AG3446X_ATTR_AVER_ENABLED,         						"CALC:AVER",                ""      },
...
{   /* Attribute ID,                  			SCPI command          */
    ...
    { AG3446X_ATTR_SCALE_DBM_REFERENCE, 		"CALC:SCAL:DBM:REF",       		""      },
    { AG3446X_ATTR_SCALE_DB_REFERENCE,  		"CALC:SCAL:DB:REF",        		""      },
                                                ...
                                                ViReal64 range, ViReal64 resolution)
{
    ...
    viCheckParm (Ivi_SetAttributeViReal64 (vi, VI_NULL, AG3446X_ATTR_RANGE,
                                           0, range), 3, "Range");
	// if they use once it should throw error.
 ...
 * Note:     The driver assumes that you are using a Platinum Resistance
 *           Temperature Device.
 *****************************************************************************/
 ...
 *            
 *            Notes:
 *            (1) This function applies only to the 34465A and the34470A, and
 ...
 * Purpose:   This function configures measurement and trigger parameters to their defalt value.
 *******************************************************************************/
 ...
 *               AG3446X_ATTR_APERTURE_TIME_UNITS attirbutes.
 *****************************************************************************/
 ...
 * Note:      You must set "EnableAverage" control to true in
                                                      ...
                                                      ViReal64* peakToPeakValue)
{
    ...
    checkErr (Ivi_GetAttributeViBoolean (vi, VI_NULL,
                                         AG3446X_ATTR_AVER_ENABLED, 0, &mathEnable));

    if (!mathEnable)
        viCheckErrElab (IVI_ERROR_INVALID_CONFIGURATION,
                        "Cannot get correct statistics value when statistics is disabled.");
                                 ...
                                 ViBoolean reset, ViSession vi)
{
    ...
    else
    {
        ...
        if ((strncmp (modelStr, "34460A", strlen ("34460A")) == 0))
            modelNum = AG3446X_VAL_MODEL_34460A;
                                                         ...
                                                         ViReal64 value)
{
    ...
    case AG3446X_VAL_DC_VOLTS_RATIO:
        if (value == AG3446X_VAL_AUTO_RANGE_ON)
			...
			viCheckErr (viPrintf (io, "VOLT:DC:RANG:AUTO OFF;"));
            viCheckErr (viPrintf (io, "VOLT:DC:RANG %lf;", AG3446X_ATTR_RESOLUTION_ABSOLUTE));
        break;
                                                                      ...
                                                                      IviRangeTablePtr *rangeTablePtr)
{
	...
	if ((IS_34465A(model) || IS_34470A(model)) && IS_DIG_INSTALLED(option))
	{
                                                               ...
                                                               ViReal64 *value)
{
	...
	if (apertureTimeUnit == AG3446X_VAL_SECONDS)
	{
...
/* AG3446X_ATTR_SCALE_DB_REFERENCE */
/* use common read callback ag3446xViReal64_ReadCallback */
                                                            ...
                                                            ViInt32 value)
{
	...
	{   /* AG3446X_VAL_CONF_MEAS_CAP applies only to 34465A and 34470A */ 
		if (!IS_34465A(model) && !IS_34470A(model))
		{
                                                                ...
                                                                ViReal64 value)
{
	...
	if ((!IS_34465A(model) && !IS_34470A(model)) || !IS_DIG_INSTALLED(options))
	{
                                                                        ...
                                                                        ViReal64 *coercedValue)
{
	...
	if (measFunc == AG3446X_VAL_DC_VOLTS || measFunc == AG3446X_VAL_DC_CURRENT
...
static ViStatus ag3446x_InitAttributes (ViSession vi, ViInt32 modelNum)
{
	...
	checkErr (Ivi_AddAttributeViInt32 (vi, AG3446X_ATTR_MODEL, "AG3446X_ATTR_MODEL",
	                                   AG3446X_VAL_MODEL_34461A, 0, VI_NULL, VI_NULL,
	                                   &attrModel));
	...
	checkErr (Ivi_AddAttributeViString (vi, AG3446X_ATTR_ID_QUERY_RESPONSE,
	                                    "AG3446X_ATTR_ID_QUERY_RESPONSE",
	                                    "Agilent/Keisight Technologies,34460A",
	...
	if (!IS_34465A(modelNum) && !IS_34470A(modelNum))
	{
