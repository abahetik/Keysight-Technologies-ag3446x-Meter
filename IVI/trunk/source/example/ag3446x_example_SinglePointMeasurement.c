 ...
 *
 *  Purpose:  This sample program reads single point measurements from the 
 *            instrument. It initializes the DMM, configures it for a 
...

{
    ...
    checkErr( ag3446x_Read (ag3446x, 5000, &reading));
    
    sprintf (msgStr, "Reading = %f", reading);
